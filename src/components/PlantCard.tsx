...
const cardWrapper = cva("rounded-lg p-[2px] cursor-pointer aspect-square");
const cardInner = cva(
  "rounded-[calc(0.5rem-2px)] bg-[#fffdf6] w-full h-full flex flex-col items-center justify-center relative overflow-hidden",
);
